...
Axial is a **liquidity and compliance engine** for Philippine MSMEs. The job-to-be-done is **working capital financing** from confirmed receivables; the product claim is **instant capital** and **effortless compliance**. It lets businesses unlock cash through Stellar/Soroban atomic swaps into USDC (proceeds displayed in PHP), automatically split and route statutory payroll obligations (SSS, PhilHealth, Pag-IBIG), and generate BIR EIS payloads after ledger-final events and surface them for one-click review and submission — without legacy ERP anxiety. *(Compliance Co-Pilot: prepare → review → submit; auto-submission gated on PTT. Buyer-frame / category stack: [Axial.md](Axial.md) 2026-07-18.)*
