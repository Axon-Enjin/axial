...
<svg width="900" height="1100" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="844" y="104" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="20" font-weight="700" fill="#0f172a">${id}</text>
  ...
  <text x="480" y="248" font-family="Arial, Helvetica, sans-serif" font-size="22" font-weight="700" fill="#0f172a">${party}</text>
  <text x="480" y="274" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#334155">TIN: 333-444-555-00000</text>
  <text x="480" y="296" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#334155">Cebu City, Philippines</text>
  ...
  <text x="72" y="420" font-family="Arial, Helvetica, sans-serif" font-size="16" fill="#0f172a">Freight handling Net 60</text>
  ...
  <text x="56" y="1040" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#94a3b8">BILL TO ${party} · Invoice Number: ${id} · Axial Demo — OCR sample</text>
</svg>`;
const name = "invoice-inv-2026-7705-harbor-micro.png";
