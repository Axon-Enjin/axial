...
/** ₱113 @ 56.5 → 2 whole USDC face → 1 USDC advance (85%). */
...
<svg width="900" height="1100" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="844" y="104" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="20" font-weight="700" fill="#0f172a">INV-2026-7703</text>
  ...
  <text x="480" y="248" font-family="Arial, Helvetica, sans-serif" font-size="22" font-weight="700" fill="#0f172a">Stellar</text>
  <text x="480" y="274" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#334155">TIN: 111-222-333-00000</text>
  <text x="480" y="296" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#334155">BGC, Taguig City, Metro Manila, Philippines</text>
  ...
  <text x="72" y="420" font-family="Arial, Helvetica, sans-serif" font-size="16" fill="#0f172a">Network integration services Net 60</text>
  <text x="420" y="420" font-family="Arial, Helvetica, sans-serif" font-size="16" fill="#0f172a">1</text>
  <text x="520" y="420" font-family="Arial, Helvetica, sans-serif" font-size="16" fill="#0f172a">PHP 113.00</text>
  <text x="720" y="420" font-family="Arial, Helvetica, sans-serif" font-size="16" fill="#0f172a">PHP 113.00</text>
  ...
  <text x="844" y="520" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="15" fill="#0f172a">PHP 113.00</text>
  <text x="560" y="560" font-family="Arial, Helvetica, sans-serif" font-size="18" font-weight="700" fill="#0f172a">TOTAL AMOUNT DUE</text>
  <text x="844" y="560" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="20" font-weight="700" fill="#0f172a">PHP 113.00</text>
  ...
  <text x="56" y="710" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#64748b">Micro Mainnet demo — ~2 USDC face / ~1 USDC advance at 56.50 FX.</text>
  ...
  <text x="56" y="1040" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#94a3b8">BILL TO Stellar · Invoice Number: INV-2026-7703 · Axial Demo — OCR sample</text>
</svg>`;

const name = "invoice-inv-2026-7703-stellar-micro.png";
const outPublic = path.join(root, "web", "public", "samples", "invoices", name);
const outDocs = path.join(root, "docs", "samples", "invoices", name);
