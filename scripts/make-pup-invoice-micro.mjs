...
/** ₱113 @ 56.5 → 2 whole USDC face → 1 USDC advance (85%) — fits ~1 USDC funder. */
...
<svg width="900" height="1100" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="844" y="104" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="20" font-weight="700" fill="#0f172a">INV-2026-7702</text>
  ...
  <text x="72" y="420" font-family="Arial, Helvetica, sans-serif" font-size="16" fill="#0f172a">Micro demo campus supply Net 60</text>
  ...
  <text x="56" y="1040" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#94a3b8">BILL TO PUP · Invoice Number: INV-2026-7702 · Axial Demo — OCR sample</text>
</svg>`;

const name = "invoice-inv-2026-7702-pup-micro.png";
